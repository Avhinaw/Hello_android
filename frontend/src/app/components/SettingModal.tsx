...
export default function SettingModal() {
  ...
  const { showSettingsModal, closeModal } = useModal();
  if (!showSettingsModal) return null;
  return (
    <div className='backdrop-blur-lg bg-[rgba(85,83,63,0.3)] p-6 text-whitebg-transparent shadow-lg w-screen h-screen z-70 absolute rounded-xl transform transition-all duration-500 ease-in-out space-y-4 dark:text-white' >
    <div className='backdrop-blur-lg bg-[rgba(85,83,63,0.3)] p-6 text-whitebg-transparent shadow-lg lg:w-[25vw] lg:h-[38vh] z-5 absolute lg:bottom-70 lg:left-130 rounded-xl transform transition-all duration-1000 ease-in-out space-y-4 dark:text-white'>
      <div className='flex justify-between items-start'>
        ...
        <SlClose className='text-lg hover:scale-125 transition duration-200' onClick={closeModal} />
      </div>
        <div>
